...
\begin{landscape}
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{|p{3.5cm}|p{1.7cm}|p{1.7cm}|p{1.7cm}|p{1.7cm}|p{1.7cm}|p{1.9cm}|p{1.7cm}|}
			\hline
			%& \tiny{Actuator} & \raggedright \tiny{(i) sensor-actuator} & \raggedright \tiny{(ii) connection/breaking} & \raggedright \tiny{(iii) obstruction} & \raggedright \tiny{(iv) structural/surface interaction} & \raggedright \tiny{(v) conductivity} & \tiny{(vi) logic} \\
